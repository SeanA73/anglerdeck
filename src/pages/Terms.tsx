    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 max-w-3xl">
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-muted-foreground mb-6">
            The AI Fishing Assistant (available to Pro and Elite subscribers) uses OpenAI's
            language models. Responses are generated by AI and may contain inaccuracies or
            outdated information. Do not rely on AI responses for safety-critical decisions.
            Messages you send to the AI Assistant are transmitted to OpenAI.
          </p>
