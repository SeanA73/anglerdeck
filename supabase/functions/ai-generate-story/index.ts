...
Keep it to 2-3 sentences. Include 1-2 relevant hashtags at the end.`;
      ...
      prompt = `Write a helpful fishing tip about ${topic} for the ReelSpot community.
...
Keep it practical and actionable, 2-3 sentences max. Add 1-2 hashtags.`;
      ...
      prompt = `Write a short, engaging story about ${topic} for the ReelSpot fishing community.
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: "You are a creative writer helping anglers craft engaging social media posts for the ReelSpot fishing community. Keep posts authentic, relatable, and under 280 characters when possible." 
          },
